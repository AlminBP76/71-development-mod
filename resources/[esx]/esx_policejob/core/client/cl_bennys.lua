...
local bennyLocation = vector3(462.100006, -1019, 28.10000)





local bennyHeading = 89.0
            ...
            if nearDefault then
                ...
                if nearDefault then
                    if not isPlyInBennys then
                        Draw3DText(bennyLocation.x, bennyLocation.y, bennyLocation.z + 0.5, "[Pritisni ~y~E~w~ - Pristupi modifikacijama vozila]", 255, 255, 255, 255, 4, 0.45, true, true, true, true, 0, 0, 0, 0, 55)
...
AddEventHandler("np-bennys:purchaseSuccessful", function()
    ...
    ESX.ShowNotification("Notifikacija prilagodjena vozilu")
end)
