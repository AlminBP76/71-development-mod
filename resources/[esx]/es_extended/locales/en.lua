Locales['en'] = {
  ...
  -- Key mapping
  ['keymap_showinventory'] = 'Otvori Inventar',

  -- Salary related
  ['received_salary'] = 'Dobio si platu u iznosu od: ~g~$%s~s~',
  ['received_help'] = 'Dobio si socijalnu pomoc u iznosu od: ~g~$%s~s~',
  ['company_nomoney'] = 'Firma u kojoj si zaposljen nema novaca da vam isplati platu',
  ['received_paycheck'] = 'primljena plata',
  ['bank'] = 'Banka',
  ['account_bank'] = 'Banka',
