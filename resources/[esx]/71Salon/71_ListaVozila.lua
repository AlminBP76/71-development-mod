...
Almin.RandomStr = function(length)
	if length > 0 then
		return Almin.RandomStr(length-1) .. StringCharset[math.random(1, #StringCharset)]
	else
		return ''
	end
end

Almin.RandomInt = function(length)
	if length > 0 then
		return Almin.RandomInt(length-1) .. NumberCharset[math.random(1, #NumberCharset)]
	else
		return ''
	end
end

Almin.SplitStr = function(str, delimiter)
	local result = { }
	local from  = 1
...
----------MUST BE ENABLED FOR THE BELOW VEHICLES-------------+set sv_enforceGameBuild 2189-------------------------------
	...
	----------MORATE UKLJUCITI U SERVER.CFG DA BI VOZILA ISPOD RADILA-------------+set sv_enforceGameBuild 2372-------------------------------
		----------MORATE UKLJUCITI U SERVER.CFG DA BI VOZILA ISPOD RADILA-------------+set sv_enforceGameBuild 2372-------------------------------
			----------MORATE UKLJUCITI U SERVER.CFG DA BI VOZILA ISPOD RADILA-------------+set sv_enforceGameBuild 2372-------------------------------
				----------MORATE UKLJUCITI U SERVER.CFG DA BI VOZILA ISPOD RADILA-------------+set sv_enforceGameBuild 2372-------------------------------
					----------MORATE UKLJUCITI U SERVER.CFG DA BI VOZILA ISPOD RADILA-------------+set sv_enforceGameBuild 2372-------------------------------
