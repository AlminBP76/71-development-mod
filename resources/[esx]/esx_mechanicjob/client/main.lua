...
function OpenMechanicActionsMenu()
	local elements = {
		...
		--{label = _U('work_wear'),      value = 'cloakroom'},  ---I OVO U FIVEM APPEARANCE KAO BOLNICA I PD
		--{label = _U('civ_wear'),       value = 'cloakroom2'}, ---I OVO U FIVEM APPEARANCE KAO BOLNICA I PD
