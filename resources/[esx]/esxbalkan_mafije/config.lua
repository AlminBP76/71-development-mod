...
Config.Webhuk = "https://discord.com/api/webhooks/933841534913245294/RxlUvGknNDEZdKgWVuP-LZ9RdTna8VnYziCDoNF1QAdJIFsiia3lTkhil2lL24kmKlyQ" -- Ovdje dodajete svoj wehuk za mafije da imate logove itd :)
Config.UkljuciPranje = false -- Ovdje mozete iskljuciti pranje novca kao sef...
Config.Locale  = 'hr'
