return {
	General = {
		...
		blip = {
			...
			{ name = 'water', price = 10 },
			{ name = 'cola', price = 10 },
			{ name = 'ugovor', price = 250 },
			{ name = 'blue_phone', price = 550 },
		}, locations = {
	...
	YouTool = {
		...
		blip = {
			...
			{ name = 'lithium', price = 25 },
			{ name = 'acetone', price = 30 },
		}, locations = {
	...
	BlackMarketArms = {
		...
		inventory = {
			...
			{ name = 'methlab', price = 500, currency = 'black_money' }
		}, locations = {
			vec3(1208.73, -3115.31, 5.54)
		}, targets = {
			{ loc = vec3(1209.47, -3114.95, 5.85), length = 1.6, width = 1.5, heading = 360.0, minZ = 5.54, maxZ = 6.54, distance = 3.0 }
		}
	},

	VendingMachineDrinks = {
		name = 'Automatu za pice',
		inventory = {
			{ name = 'water', price = 10 },
			{ name = 'cola', price = 10 },
		},
