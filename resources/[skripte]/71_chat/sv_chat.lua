...
local function routeMessage(source, author, message, mode, fromConsole)
	...
	PerformHttpRequest("tvojwebhuk", function(err, text, headers) end, 'POST', json.encode({username = ime, content = poruka, avatar_url = "qfqfqfqq"}), { ['Content-Type'] = 'application/json' })
