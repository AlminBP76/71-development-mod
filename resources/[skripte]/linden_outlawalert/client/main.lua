...
RegisterKeyMapping('alert_gps', 'Postavi Waypoint (dispatch)', 'keyboard', 'G')
...
RegisterKeyMapping('alert_dead', 'Posalji signal bolnici/policiji (dispatch)', 'keyboard', 'G')

RegisterCommand('911', function(playerId, args, rawCommand)
	if not args[1] then ESX.ShowNotification("Moras unijeti poruku!") return end
	...
	ESX.ShowNotification("Tvoj zahtjev za pomoc je poslat!")
end, false)
